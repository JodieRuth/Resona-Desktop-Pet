...
class SettingsDialog(QDialog):
    ...
    def _create_appearance_tab(self) -> QWidget:
        ...
        self.header_offset_x_spin.setRange(-500, 500)
        self.header_offset_x_spin.setSingleStep(1)
        self.header_offset_x_spin.setSuffix(" px")
        header_offset_layout.addWidget(QLabel("X:"))
        header_offset_layout.addWidget(self.header_offset_x_spin)
        self.header_offset_y_spin = QSpinBox()
        self.header_offset_y_spin.setRange(-500, 500)
        self.header_offset_y_spin.setSingleStep(1)
        self.header_offset_y_spin.setSuffix(" px")
        ...
        self.text_offset_x_spin.setRange(-500, 500)
        self.text_offset_x_spin.setSingleStep(1)
        self.text_offset_x_spin.setSuffix(" px")
        text_offset_layout.addWidget(QLabel("X:"))
        text_offset_layout.addWidget(self.text_offset_x_spin)
        self.text_offset_y_spin = QSpinBox()
        self.text_offset_y_spin.setRange(-500, 500)
        self.text_offset_y_spin.setSingleStep(1)
        self.text_offset_y_spin.setSuffix(" px")
    ...
    def _load_settings(self):
        ...
        self.header_offset_x_spin.setValue(int(self.config.get("General", "header_offset_x", "0")))
        self.header_offset_y_spin.setValue(int(self.config.get("General", "header_offset_y", "0")))
        self.text_offset_x_spin.setValue(int(self.config.get("General", "text_offset_x", "0")))
        self.text_offset_y_spin.setValue(int(self.config.get("General", "text_offset_y", "0")))
    ...
    def _save_settings(self):
        ...
        try:
            ...
            self.config.set("General", "header_offset_x", str(self.header_offset_x_spin.value()))
            self.config.set("General", "header_offset_y", str(self.header_offset_y_spin.value()))
            self.config.set("General", "text_offset_x", str(self.text_offset_x_spin.value()))
            self.config.set("General", "text_offset_y", str(self.text_offset_y_spin.value()))
